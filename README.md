...
저는,
  ...
  - 현재는 Toss Core에서 활성 유져 지표 관리, 전사 DW 표준 마트 설계/개발/운영을 담당하며 데이터 애널리틱스 앤지니어로 근무하고 있습니다.
...
* [back-end] - 배치 작업 구현 및 운영(pyspark, Airflow, shell script 사용), 화면 연동 서비스 프로그램 개발(ProC 사용)
